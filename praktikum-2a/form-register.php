...
<form method="POST" action="hasil-form-regis.php" class="container"mt-5>
    <fieldset class ="border border-dark p-3 rounded" style="background-color: lightpink";>
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nim" name="nim" placeholder="*0110124043" type="text" class="form-control" required="required" pattern="[0-9]{10}" title="NIM Harus 10 Digit Angka">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nama_lengkap" name="nama_lengkap" placeholder="*Fairuz Ghina Mufidah" type="text" class="form-control" required="required" minlength="3" maxlength="50">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="custom-control custom-radio custom-control-inline">
        <input name="jenis_kelamin" id="jenis_kelamin_0" type="radio" class="custom-control-input" value="Laki - Laki"checked required="required"> 
